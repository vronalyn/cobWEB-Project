    ...
    submitDatabtn.addEventListener('click', (e) => {
        ...
        var Dateadd = new Date().toLocaleString(); // get current date and time

        if (RegionAdd && MunicipalityAdd && PovertyIncidenceAdd) {
            const docRef = addDoc(collection(db, "2012city"), {
                Region: RegionAdd,
                ...
                addDoc(activityLogCollection, {
                  ...
                  details: `${MunicipalityAdd} data has been added to the 2012 Municipal and City Poverty Dataset.`
                }).then(() => {
